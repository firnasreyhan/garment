                      ...
                      >
                        ...
                        <div className="ml-4 flex gap-2">
                          <button
                            ...
                            disabled={saving}
                            title={`Print Disposisi ${progressMain.opmName || progressMainNames[index] || `Stage #${index + 1}`}`}
                          >
                        ...
                        <div className="text-center py-6 text-white border-t border-gray-200">
                          ...
                          {orderData?.oIsLockProgress === 0 && (
                            <button
                              ...
                              className="px-4 py-2 bg-white text-black text-sm rounded-lg hover:bg-white/90"
                            >
